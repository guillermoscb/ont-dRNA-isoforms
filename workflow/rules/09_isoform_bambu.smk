rule isoform_bambu:
    ...
    output:
        ...
        se_novel_transcripts="{output_path}/results/isoform_bambu/{sampleid}/summarized_experiment-{basecaller}-{cmp}-{qscore}/novel_transcripts_filt.gtf",
        se_novel_flen="{output_path}/results/isoform_bambu/{sampleid}/summarized_experiment-{basecaller}-{cmp}-{qscore}/full-length_transcripts_filt.gtf",
    params:
